...
* :ref:`nrf_profiler` library:
  ...
  * Added sending :kconfig:option:`CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC` through the info RTT channel as part of the system description.
    ...
    The system configuration details are formatted as a list of key-type-value data, for example: ``key1,u32,value1``. Subsequent entries are separated by newlines.
